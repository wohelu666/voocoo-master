...
public class FeedRecordsActivity extends AbsBaseActivity {
    ...
    private void initData() {
        HttpManage.getInstance().feedDevDetail(device.getDeviceId(), new HttpManage.ResultCallback<String>() {
            @Override
    ...
    private void initView() {
        ...
        tvTitle.setText(getString(R.string.text_food_records));

        rvWaterRecords.setLayoutManager(new LinearLayoutManager(FeedRecordsActivity.this));

        useRecordListAdapter = new UseRecordListAdapter(FeedRecordsActivity.this);
